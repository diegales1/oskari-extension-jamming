 ...
 */
@OskariActionRoute("CapsusLayerSave")
public class CapsusLayerSave extends AbstractLayerAdminHandler {
    ...
    private static final Logger LOG = LogFactory.getLogger(CapsusLayerSave.class);
    ...
    public void handleGet(ActionParameters params) throws ActionException {
        ...
        LOG.debug("en handlePost:", params.getUser());
        for(Map.Entry<String,String[]> entry : params.getRequest().getParameterMap().entrySet()){    
            LOG.info("siguiente param: "+entry.getKey()+" >>> "+entry.getValue()[0]);
        }
...
/* AS OF YET, IT SEEMS WE CANT WORK WITH JSONS, ONLY X-APPLICATION-FORM-URLENCODED DATA, OTHERWISE THE FURTHER CALLS TO params.getParameter(String) WONT WORK
//        JSONObject json = params.getPayLoadJSON();
//        LOG.info("Va la cadenota::::::::: "+json.toString());
//        
...
//            try{
//                LOG.info("sig param json::  "+key+" : "+json.get(key));
//                strarr = new String[1];
//                strarr[0] = (String)json.get(key);
//                params.getRequest().getParameterMap().put(key, strarr);
//            }catch(Exception ex){
//                LOG.debug("exception en jsons..."+ex.getMessage());
//            }
//        }
        */
