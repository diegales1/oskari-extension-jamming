...
import org.oskari.control.userlayer.*;
 ...
 */
@OskariActionRoute("AnotherAction")
public class AnotherActionHandler extends RestActionHandler {

    private static final Logger log = LogFactory.getLogger(AnotherActionHandler.class);
    ...
    public void handleGet(ActionParameters params) throws ActionException {
        ResponseHelper.writeResponse(params, "another action.... should be a post with a zip... " + params.getUser().getFullName());
    ...
    public void handlePost(ActionParameters params) throws ActionException {
        ...
        for(int i=0; i<fileItems.size(); i++){
            log.info("Size de fileItems: "+fileItems.size());
            log.info("File item "+i+":  "+ fileItems.get(i));
        }
        ...
        try {
            ...
            log.debug("Using value from field:", zipFile.getFieldName(), "as the zip file  ****************************************************** modified");
